...
func (that EasyCurdModels) NodeForm(pageData *EasyApp.PageData, id int64) (error, int) {
	...
	pageData.FormFieldsAdd("allow_select", "radio", "允许查询", "", "1", true, Models2.DefaultIsOrNot, "", nil)
	pageData.FormFieldsAdd("allow_create", "radio", "允许新增", "", "0", true, Models2.DefaultIsOrNot, "", nil)
	pageData.FormFieldsAdd("allow_update", "radio", "允许更新", "", "0", true, Models2.DefaultIsOrNot, "", nil)
	pageData.FormFieldsAdd("allow_delete", "radio", "允许删除", "", "0", true, Models2.DefaultIsOrNot, "", nil)
	pageData.FormFieldsAdd("soft_delete_disable", "radio", "禁用软删除", "", "0", true, Models2.DefaultIsOrNot, "", nil)
	pageData.FormFieldsAdd("check_login", "radio", "校验登录", "", "0", true, Models2.DefaultIsOrNot, "", nil)
	pageData.FormFieldsAdd("select_with_disabled", "radio", "禁用/取消可查", "status=0的数据是否可以查询", "0", true, Models2.DefaultIsOrNot, "", nil)
